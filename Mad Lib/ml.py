...
#Level One: Simple Mad Lib
#Level Two: You need to say if it is either a noun, verb or adjective, and there is the multiple options. For example (is this a verb, is this a noun). We do it easy for them so they only have 2 choices
#Level Three: The same as level 2 except they have more choices so it is harder.
#Level Four: They Do not have any choices, they need to guess either it's a noun, verb or adjective
#Level Five: They need to try to find a noun or adjective or verb in the sentence
#Level Six: Fill in the blank
#Level Seven: Educational questions
#Level Eight: They need to create their own mad lib, with our choice of words, except the list we give them is mixed up so it is harder.
#Level Nine: They customize their own Mad Lib that they can share with friends, like that there friends can play.
#The Code written bellow is a gide###
#I love guides!!! 
#YAYAYAYAYYAYYAYAYAYYYAYAYAYYAYAY!!!!
#This is a gide!!!!
#if noun1 == "haha" > 3:
   # print(first_question)
   #USE WHILE LOOPS IF FAILED QUESTION
#While loop for going back to the other question if fail:
#if (name of the question) == "(the good answer for the question)":
    #print("the next question")
#else while (name of the question) < 2
#ml = input("Take a (noun) and other things found in your (noun) and (verb) them against a tree. Then cover the (noun) with leaves. Now you have your own (noun).")
#print(ml)
#noun1 = input("Please enter a first noun: ")
#print(noun1)
...
#print("Take a " + noun1 + " and other things found in your " + noun2 + " and " + verb + " them against a tree. Then cover the " + noun3 + " with leaves. Now you have your own " + noun4)




#Flo and Salome code here: (Only here cuz the code above is very confusing.)
#count = 0
#while (count < 20)
